...
The useNavigate hook from React Router provides a more flexible way to programmatically navigate to different routes. It allows you to trigger navigation from within your components without relying on the `<Link>` component.
...
The useParams hook is a part of React Router, a popular library for handling routing in React applications. It allows you to access the dynamic parameters in the URL within your component.
When you have a dynamic route like `/user/:id`, the useParams hook can be used to retrieve the value of `:id:`
